...
/**
* Испольщуется для того, чтобы
 * 1. обеспечить глобальный доступ к конфигурационным данным
 * 2. рендерить страницу
 * 3. добавлять контейнер для работы реестра - регистрация или использование нового роута
 */
namespace Nin\EnterpriseAppTemplate\Registry\Framework;
